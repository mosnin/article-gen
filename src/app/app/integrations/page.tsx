...
function WebflowIcon() {
  return (
    <div className="flex h-8 w-8 items-center justify-center rounded-full bg-[#4353FF] text-white font-bold text-base">
      W
    </div>
  );
}
...
function WixIcon() {
  return (
    <div className="flex h-8 w-8 items-center justify-center rounded-full bg-black">
      <span className="text-white text-[10px] font-black tracking-tight">WIX</span>
    </div>
  );
}
...
function WebhookIcon() {
  return (
    <div className="flex h-8 w-8 items-center justify-center rounded-lg bg-[var(--surface-sunken)] border border-[var(--border-default)]">
      <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" className="h-5 w-5 text-[var(--text-secondary)]">
...
function FramerIcon() {
  return (
    <svg viewBox="0 0 24 24" className="h-8 w-8" fill="#0055FF">
...
function GhostIcon() {
  return (
    <svg viewBox="0 0 24 24" className="h-8 w-8" fill="#15171A">
...
function FeatherIcon() {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" className="h-8 w-8 text-[var(--text-secondary)]">
    ...
    <div className="space-y-8">
      <div>
        ...
        <p className="mt-1 text-sm text-[var(--text-secondary)]">
          Connect your website to automatically publish articles
        </p>
      </div>
        ...
        {integrations.map((integration) => {
          ...
          return (
            <div
              key={integration.id}
              className={cn(
                "group relative flex flex-col gap-4 bg-[var(--surface-base)] border border-[var(--border-default)] rounded-xl p-5 transition-colors duration-150",
            ...
            >
              ...
              <div className="flex items-start justify-between">
                ...
                {integration.comingSoon && (
                  <span className="rounded-full bg-[var(--surface-sunken)] border border-[var(--border-default)] px-2 py-0.5 text-[10px] font-medium uppercase tracking-wide text-[var(--text-tertiary)]">
                    Soon
                  </span>
                )}
              ...
              {integration.available && (
                <button
                  ...
                  className={cn(
                    "w-full rounded-lg border px-3 py-1.5 text-xs font-medium transition-colors duration-150",
                    isConnected
                      ? "border-[var(--border-default)] text-[var(--text-secondary)] hover:border-[var(--accent-light)] hover:text-[var(--accent)]"
                      : "border-[var(--border-default)] text-[var(--text-primary)] hover:border-[var(--accent)] hover:text-[var(--accent)] hover:bg-[var(--accent-light)]"
                  )}
                >
