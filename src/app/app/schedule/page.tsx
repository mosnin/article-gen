    ...
    <div style={{ background: "var(--background)", minHeight: "100vh" }}>
      ...
      <main style={{ maxWidth: 960, margin: "0 auto", padding: "32px 24px" }}>
        ...
        <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: 24 }}>
          <div>
            <h1 style={{ fontSize: 24, fontWeight: 800, marginBottom: 4 }}>Scheduled Articles</h1>
            <p style={{ fontSize: 13, color: "var(--muted)" }}>
              Schedule articles for automatic generation and publishing. No browser needed.
            </p>
          </div>
          <button
        ...
        {schedules.length === 0 && !showForm && (
          <div style={{ textAlign: "center", padding: "60px 20px" }}>
            ...
            <h3 style={{ fontSize: 18, fontWeight: 700, marginBottom: 6 }}>No scheduled articles</h3>
            <p style={{ fontSize: 13, color: "var(--muted)", marginBottom: 20, maxWidth: 400, margin: "0 auto 20px" }}>
              Schedule articles to be generated and published automatically. They run in the background, no browser needed.
            </p>
            <button
