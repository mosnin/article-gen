        ...
        <div className="mx-auto max-w-5xl">
          ...
          <div className="grid gap-4 md:grid-cols-2">
            {[
              ...
              { title: "Automated Publishing", description: "Automate article generation and publishing on autopilot. Runs in the background with daily and weekly recurrence.", icon: <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="var(--accent)" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"><path d="M12 2v4" /><path d="m16.2 7.8 2.9-2.9" /><path d="M18 12h4" /><path d="m16.2 16.2 2.9 2.9" /><path d="M12 18v4" /><path d="m4.9 19.1 2.9-2.9" /><path d="M2 12h4" /><path d="m4.9 4.9 2.9 2.9" /></svg> },
            ].map((feature, i) => (
        ...
        <div className="mx-auto max-w-5xl">
          ...
          <div className="grid gap-5 md:grid-cols-4">
            {[
              ...
              { name: "Growth", price: "$50", period: "/mo", credits: "120", features: ["120 articles/month", "Standard & premium quality", "Topic clusters", "Batch + automation", "Priority support"], cta: "Subscribe", featured: true },
              { name: "Pro", price: "$99", period: "/mo", credits: "300", features: ["300 articles/month", "Standard & premium quality", "Topic clusters", "Batch + automation", "Dedicated support"], cta: "Subscribe", featured: false },
            ].map((plan, i) => (
