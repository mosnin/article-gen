...
export function Sidebar({
  ...
  const researchSubNav: NavItem[] = [
    ...
    },
    {
      ...
      href: "/app/research/cannibalization",
      icon: (
        <svg viewBox="0 0 20 20" fill="currentColor" className="w-4 h-4">
          <path fillRule="evenodd" d="M3 10a7 7 0 0114 0A7 7 0 013 10zm7-3a1 1 0 00-1 1v2a1 1 0 002 0V8a1 1 0 00-1-1zm0 6a1 1 0 100 2 1 1 0 000-2z" clipRule="evenodd" />
        </svg>
      ),
    },
    {
      label: "Image audit",
      href: "/app/research/image-audit",
      icon: (
        <svg viewBox="0 0 20 20" fill="currentColor" className="w-4 h-4">
    ...
    },
    {
      ...
      icon: (
        <svg viewBox="0 0 20 20" fill="currentColor" className="w-4 h-4">
          <path fillRule="evenodd" d="M10 1a1 1 0 011 1v1.323l3.954 1.582 1.599-.8a1 1 0 01.894 1.79l-1.233.616 1.738 5.42a1 1 0 01-.285 1.05A3.989 3.989 0 0115 14a3.989 3.989 0 01-2.667-1.019 1 1 0 01-.285-1.05l1.715-5.349L11 5.697V16h2a1 1 0 110 2H7a1 1 0 110-2h2V5.697L6.237 6.582l1.715 5.349a1 1 0 01-.285 1.05A3.989 3.989 0 015 14a3.989 3.989 0 01-2.667-1.019 1 1 0 01-.285-1.05l1.738-5.42-1.233-.617a1 1 0 01.894-1.788l1.599.799L9 3.323V2a1 1 0 011-1zm-5 8.274l-.818 2.552c.25.112.526.174.818.174.292 0 .569-.062.818-.174L5 9.274zm10 0l-.818 2.552c.25.112.526.174.818.174.292 0 .569-.062.818-.174L15 9.274z" clipRule="evenodd" />
        </svg>
      ),
    },
  ];
  ...
  const configNav: NavItem[] = [
    ...
    },
    {
      ...
      icon: (
        <svg viewBox="0 0 20 20" fill="currentColor" className="w-4 h-4">
          <path d="M5.5 17a4.5 4.5 0 01-1.44-8.765 4.5 4.5 0 018.302-3.046 3.5 3.5 0 014.504 4.272A4 4 0 0115 17H5.5zm5.25-9.25a.75.75 0 00-1.5 0v4.59l-1.95-2.1a.75.75 0 10-1.1 1.02l3.25 3.5a.75.75 0 001.1 0l3.25-3.5a.75.75 0 10-1.1-1.02l-1.95 2.1V7.75z" />
        </svg>
      ),
    },
  ];
      ...
      <div className="shrink-0 border-t border-[var(--border-default)] px-3 py-3 space-y-2.5">
        ...
        <div className="flex items-center justify-between px-1">
          <button
            ...
            className="flex items-center gap-2 rounded-lg px-2 py-1.5 text-[11px] text-[var(--text-tertiary)] hover:bg-[var(--surface-sunken)] hover:text-[var(--text-primary)] transition-colors focus:outline-none focus-visible:ring-2 focus-visible:ring-[var(--border-focus)]"
          >
            {isDark ? (
              /* Sun icon */
